...
-->
    ...
    <script>
        function drawtable(resultrow) {
            ...
            return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.product + "</td><td>" + resultrow.rateperkgusd + "</td><td>" + resultrow.appliedqty + "</td><td>" + resultrow.cifwithoutnormusd + "</td><td>" + resultrow.norm + "</td><td>" + resultrow.finalqty + "</td><td>" + resultrow.cifinusd + "</td><td>" + resultrow.importbalanceqty + "</td><td>" + resultrow.importbalanceamount + "</td><td>" + resultrow.differenceqty + "</td><td>" + resultrow.differenceamount + "</td><td>" + resultrow.status + "</td><td><a class='btn btn-primary btn-xs' href='<?php echo site_url('site/editimport?id=');?>" + resultrow.license + "&importid="+resultrow.id+"'><i class='icon-pencil'></i></a><a class='btn btn-danger btn-xs' onclick=return confirm(\"Are you sure you want to delete?\") href='<?php echo site_url('site/deleteimport?id='); ?>" + resultrow.id + "&importid="+resultrow.id+"'><i class='icon-trash '></i></a></td></tr>";
