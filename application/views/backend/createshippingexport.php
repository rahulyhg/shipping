<div id="page-title">
    <a href="<?php echo site_url("site/viewshippingexport"); ?>" class="btn btn-primary btn-labeled fa fa-arrow-left margined pull-right">Back</a>
...
Create shippingexport </h3>
                </div>
                <div class="panel-body">
                    <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createshippingexportsubmit");?>' enctype='multipart/form-data'>
                        <div class="panel-body">
...
//echo form_dropdown("license",$license,set_value('license'),"class='chzn-select form-control'");
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="normal-field">Amount In USD</label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="normal-field" class="form-control" name="manualfobrs" value='<?php echo set_value(' manualfobrs ');?>'>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="normal-field">Actual Realised eBRC In USD</label>
                                <div class="col-sm-4">
                                    <input type="text" id="normal-field" class="form-control" name="actualrealisedebrcusd" value='<?php echo set_value(' actualrealisedebrcusd ');?>'>
                                </div>
                            </div>
                            <div class=" form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <a href="<?php echo site_url("site/viewshippingexport?id=".$license); ?>" class="btn btn-secondary">Cancel</a>
                                </div>
                            </div>
                    </form>
                    </div>
