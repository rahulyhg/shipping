...
<div id="page-content">
    ...
    <script>
        function drawtable(resultrow) {
            return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.number + "</td><td>" + resultrow.company + "</td><td>" + resultrow.issuedate + "</td><td>" + resultrow.expirydate + "</td><td>" + resultrow.extention + "</td><td>" + resultrow.status + "</td><td><a class='btn btn-primary btn-xs' href='<?php echo site_url('site/editlicense?id=');?>" + resultrow.id + "'><i class='icon-pencil'></i></a><a class='btn btn-danger btn-xs' onclick=return confirm(\"Are you sure you want to delete?\") href='<?php echo site_url('site/deletelicense?id='); ?>" + resultrow.id + "'><i class='icon-trash '></i></a></td></tr>";
        }
